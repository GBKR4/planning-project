const Button = ({ 
  ...
  const variants = {
    ...
    success: 'bg-gray-700 text-white hover:bg-gray-800 focus:ring-gray-600',
    outline: 'border-2 border-gray-600 text-gray-900 hover:bg-gray-50 focus:ring-gray-500 bg-white',
  };
